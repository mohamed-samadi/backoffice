...
export const selectDocumentsSuccess = (state) => state?.documents?.success || false;
...
export const selectPaginationData = (state) => state?.documents?.pagination || {};
export const selectCurrentPage = (state) => selectPaginationData(state).currentPage || 1;
export const selectLastPage = (state) => selectPaginationData(state).lastPage || 1;
export const selectTotalDocuments = (state) => selectPaginationData(state).total || 0;
