...
// ── Loading granulaire ────────────────────────────────────────────────────────
export const selectClientsLoadingStates   = (state) => state?.clients?.loadingStates || {};
...
// Filtre local par statut (utile pour des vues rapides sans refetch)
export const selectClientsActifs   = (state) =>
  selectClientsData(state).filter((c) => c.statut === "active");

export const selectClientsInactifs = (state) =>
  selectClientsData(state).filter((c) => c.statut === "inactive");
