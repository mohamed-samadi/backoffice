...
export default function FournisseurPage() {
  ...
  // ✅ useMemo — recalculé seulement quand villes change
  // ✅ key "ville_filter" — correspond au paramètre backend
  ...
  const handleSubmit = async (payload) => {
    try {
      // ✅ payload envoyé directement — le modal ne retourne que les bons champs
      // Pas besoin de reconstruire dataToSend manuellement
        ...
        <div className={styles.backdropDelete}>
          <div className={styles.deleteCard}>
            ...
            <p className={styles.deleteMsg}>
              ...
              <strong>{deleteConfirm.nom}</strong> ? Cette action est
              irréversible.
            </p>
